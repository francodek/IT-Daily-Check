...
namespace IT_Daily_Check.Controllers
{
    ...
    public class DeviceServicesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name")] DeviceService deviceService)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name")] DeviceService deviceService)
        {
